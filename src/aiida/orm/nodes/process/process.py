...
class ProcessNode(Sealable, Node):
    ...
    class Model(Node.Model, Sealable.Model):
        ...
        process_state: Optional[str] = MetadataField(is_attribute=True, description='The process state enum')
        process_status: Optional[str] = MetadataField(
            is_attribute=True, description='The process status is a generic status message'
        )
        exit_status: Optional[int] = MetadataField(is_attribute=True, description='The process exit status')
        exit_message: Optional[str] = MetadataField(is_attribute=True, description='The process exit message')
        exception: Optional[str] = MetadataField(is_attribute=True, description='The process exception message')
        paused: bool = MetadataField(is_attribute=True, description='Whether the process is paused')
